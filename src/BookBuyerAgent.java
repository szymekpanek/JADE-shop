			...
			switch (step) {
				...
				case 2:
					...
					if(bestPrice <= targetBudget) {
						...
						System.out.println(getAID().getLocalName() + ": " + targetBookTitle + " exceeds the budget: " + targetBudget);
						step = 4;
					}
				...
				case 3:
					...
					if (reply != null) {
						if (reply.getPerformative() == ACLMessage.INFORM) {
							...
							targetBudget -= bestPrice; // redukujemy budżet o cene zakupionej ksiazki
							System.out.println(getAID().getLocalName() + ": Budget remaining: " + targetBudget);
